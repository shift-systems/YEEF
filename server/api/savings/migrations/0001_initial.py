        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[
                 ('SS', 'Success'), ('PG', 'Pending'), ('FD', 'Failed')], default='PG', max_length=2)),
                ('financial_transaction_id', models.PositiveIntegerField(null=True)),
                ('deleted_by', models.ForeignKey(
                    null=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('saver', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL,
                                            related_name='saver', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
